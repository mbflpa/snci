...
<!--- 	AND 1 = CASE WHEN Itn_TipoUnidade = 99 And Pos_Situacao_Resp IN (1,6,7,22) THEN 0 ELSE 1 END --->
	...
	convert(char,INP_TNCPontuacao) as INPTNCPontuacao, 

...
<form action="itens_controle_respostas_tipo_unidade.cfm" method="post">
      <table width="60%" align="center"><br><br>
        <tr>
          <td colspan="5">&nbsp;</td>
        </tr>
        <tr>
        <td colspan="5"><p align="center" class="titulo1"><strong>  <strong>Auditorias por tipo de unidade</strong></strong></p>
            <p class="exibir"></td>
      </tr> 

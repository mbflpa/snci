...
<table width="98%" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="17" class="exibir"><div align="right"><a href="Fechamento/<cfoutput>#sarquivo#</cfoutput>"><img src="icones/csv.png" width="37" height="38" border="0"></a></div></td>
    </tr>
  <tr>
    <td colspan="17" class="exibir"><div align="center"><strong>RESULTADO EM RELA&Ccedil;&Atilde;O &Agrave; META <cfoutput>#ucase(cabec)#</cfoutput></strong></div>      <div align="center"></div>      <div align="center"></div></td>
    </tr>
  <tr>
    <td class="exibir">&nbsp;</td>
  ...
  <cfoutput query="rsMetas">
    ...
    <cfset DGCIM = 0>
    <!--- PRCI --->
    <cfset PRCIm = numberFormat(rsMetas.Met_PRCI,999.0)>
    <cfset PRCIAM = numberFormat(rsMetas.Met_PRCI_Acum,999.0)>
	
    <cfif PRCIAM gt PRCIm>
		  <cfset PRCIRes = "ACIMA DO ESPERADO">
		  <cfset scord1 = "##33CCFF">
     <cfelseif PRCIAM eq PRCIm>
    ...
    <cfset PRCIAcuPerReal = numberFormat(Met_PRCI_AcumPeriodo,999.0)>
	<cfif PRCIAcuPerReal gt PRCIm>
		<cfset PRCIAcuPerRealRes = "ACIMA DO ESPERADO">
		<cfset scorf1 = "##33CCFF">
	<cfelseif PRCIAcuPerReal eq PRCIm>
    ...
    <!--- SLNC --->
    <cfset SLNCm = numberFormat(rsMetas.Met_SLNC,999.0)>
    <cfset SLNCAM = numberFormat(rsMetas.Met_SLNC_Acum,999.0)>
	
	<cfif SLNCAM gt SLNCm>
	  <cfset SLNCRes = "ACIMA DO ESPERADO">
	  <cfset scroi1 = "##33CCFF">
	<cfelseif SLNCAM eq SLNCm>
    ...
    <cfset SLNCAcuPerReal = trim(numberFormat(Met_SLNC_AcumPeriodo,999.0))>
    <cfif SLNCAcuPerReal gt SLNCm>
		  <cfset SLNCAcuPerRealRes = "ACIMA DO ESPERADO">
		  <cfset scrok1 = "##33CCFF">
      <cfelseif SLNCAcuPerReal eq SLNCm>
    ...
    <cfset DGCIAM = numberFormat(rsMetas.Met_DGCI_Acum,999.0)>
	
	<cfif DGCIAM gt DGCIm>
		<cfset DGCIRes = "ACIMA DO ESPERADO">
		<cfset scorn1 = "##33CCFF">
	<cfelseif DGCIAM eq DGCIm>
    ...
    <cfset DGCIAcuPerReal = trim(numberFormat(Met_DGCI_AcumPeriodo,999.0))>

	<cfif DGCIAcuPerReal gt DGCIm>
      <cfset DGCIAcuPerRealRes = "ACIMA DO ESPERADO">
      <cfset scorp1 = "##33CCFF">
      <cfelseif DGCIAcuPerReal eq DGCIm>
    ...
    <tr>
      ...
      <td class="exibir"><div align="center"><strong>#PRCIAM#</strong></div></td>
      <td bgcolor="#scord1#" class="exibir"><div align="center">#PRCIRes#</div></td>
      <td class="exibir"><div align="center"><strong>#PRCIAcuPerReal#</strong></div></td>
      ...
      <td class="exibir"><div align="center"><strong>#SLNCAM#</strong></div></td>
      <td bgcolor="#scroi1#" class="exibir"><div align="center">#SLNCRes#</div></td>
      <td class="exibir"><div align="center"><strong>#SLNCAcuPerReal#</strong></div></td>
      <td bgcolor="#scrok1#" class="exibir"><div align="center">#SLNCAcuPerRealRes#</div></td>
      <td class="exibir"><div align="center"><strong>#DGCIm#</strong></div></td>
      <td class="exibir"><div align="center"><strong>#DGCIAM#</strong></div></td>
...
<cfset mesantes = int(month(now()) - 1)>	
<!--- <cfoutput>

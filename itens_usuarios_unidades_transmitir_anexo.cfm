...
<form name="frm1" action="itens_usuarios_unidades_receber_anexo.cfm" enctype="multipart/form-data" method="post">
...
<table width="80%" border="0" align="center">
  ...
  <tr>
    ...
    <td><input name="arquivo" class="botao" type="file" size="80"></td>
  </tr>
  <tr>
   <td class="titulos">&nbsp;</td>
   <td>

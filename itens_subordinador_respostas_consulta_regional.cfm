...
SELECT DISTINCT INP_DtInicInspecao, Pos_Unidade, Und_Descricao, Pos_Inspecao
...
HAVING (INP_DtInicInspecao Between #dtInicio# AND #dtFinal#) AND (Und_CodReop='#form.cbreop#')
...
<!--- Área de conteúdo   --->
<table width="71%" align="center" class="exibir">
  <tr>
  ...
  <tr>
    <td height="25" align="center" valign="top" colspan="7">&nbsp;</td>
  </tr>
  <tr bgcolor="eeeeee" class="exibir">
    <td height="23" class="titulos"><div align="center"><cfoutput>Unidade</cfoutput></div></td>
    <td width="346" height="16" class="titulos">Descri&ccedil;&atilde;o</td>
    <td width="215"><div align="center" class="titulos">In&iacute;cio do Relatório</div></td>
    <td width="193">&nbsp;</td>
  </tr>
<cfset strcor = "eeeeee">
 <cfset sctrl = " ">
<cfoutput query="rsItem">
<!---  <cfif sctrl neq rsItem.Pos_Unidade>--->
  <form name="frm">
 <cfset sctrl = rsItem.Pos_Unidade> 
<tr bgcolor="#strcor#">

    	<td width="125" height="26"><div align="center">#rsItem.Pos_Unidade#</div></td>

        <td width="346">#rsItem.Und_Descricao#

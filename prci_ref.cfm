...
<cfif grpacesso eq 'SUPERINTENDENTE' OR grpacesso eq 'GERENTES' OR grpacesso eq 'ORGAOSUBORDINADOR' OR grpacesso eq 'SUBORDINADORREGIONAL'>
    <cflocation url="prci.cfm?se=#qAcesso.Usu_DR#&anoexerc=#year(dtlimit)#&dtlimit=#dtlimit#&frmano=#year(dtlimit)#"> 
...
<!--- �rea de conte�do   --->
	<form action="prci.cfm" method="get" target="_blank" name="frmObjeto" onSubmit="return valida_form()">
	  ...
	  <cfif grpacesso eq "SUPERINTENDENTE">
        ...
        <tr>
          <td colspan="5" align="center" class="titulo2"><strong>Atendimento ao Prazo de Resposta do Controle Interno (PRCI)</strong> </td>
        </tr>
		<tr>
          <td colspan="5" align="center">&nbsp;</td>
        </tr>
        ...
        <tr>
          <td colspan="5" align="center"><div align="left"><strong class="titulo1">Pesquisa por:</strong></div></td>
        </tr>

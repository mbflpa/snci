...
<cfoutput>
	<cflocation url="itens_unidades_controle_respostas_reop.cfm?numero=#Form.numero_inspecao#&unidade=#FORM.numero_unidade#&numgrupo=#Form.numero_grupo#&numitem=#Form.numero_item#&reop=#Form.numero_reop#">
</cfoutput>

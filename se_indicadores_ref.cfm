...
<form action="se_indicadores.cfm" method="get" target="_blank" name="frmObjeto" onSubmit="return valida_form()">
	    <table width="33%" border="0" align="center">
	      ...
	      <tr valign="baseline">
	        <td colspan="2" class="titulo1"><div align="center"><strong>DGCI &ndash; Desempenho Geral de Controle Interno</strong></div></td>
          </tr>
	      <tr valign="baseline">
	        <td colspan="2">&nbsp;</td>
          </tr>
	      ...
	      <tr valign="baseline">
	        <td colspan="2"><div align="center"><span class="titulos">&nbsp;&nbsp;&nbsp;&nbsp;Superintend&ecirc;ncia:</span></div></td>
          </tr>
	      <tr valign="baseline">

...
<cfinvoke component="#vRelatorio#.GeraRelatorio.gerador.ctrl.controller" 
	method="geraRelatoriodata" returnvariable="qryRelatorio">
</cfinvoke>
...
<table border="0" width="100%">
 <cfif qryRelatorio.recordcount is 0>
  ...
  <tr>
    <th width="22%" rowspan="2"><div align="left"><img src="../../geral/img/logoCorreios.gif" alt="Logo ECT" width="177" height="43" align="left" /></div></th>
    <td width="80%" class="labelcell"><span class="style2">Ger&ecirc;ncia de Macrorregi&atilde;o de Auditoria</span></td>
  </tr>  
  <tr>
    <td height="30%" class="labelcell"><p class="style2">Relat&oacute;rio de Acompanhamento de Auditoria - <span class="style2"><cfoutput>#siglaDR#</cfoutput></span></p>
    </td>
  </tr>
</table>
  ...
  <tr>
    ...
    <cfelse>	   
      <td colspan="3" bgcolor="F5F5F5"><cfoutput>#qryRelatorio.TUN_Descricao#</cfoutput></td>
	</cfif>    
  </tr>
  <tr>
...
","<BR>" ,"All")>
    ...
    <td colspan="3" bgcolor="F5F5F5"><div align="justify">#recom#</div></td>
 </tr>
...
","<BR>" ,"All")>
  ...
  <tr>
    ...
    <td colspan="3" bgcolor="F5F5F5"><div align="justify">#parecer#</div></td>         
  </tr>
  <tr>
    <th valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="left" class="labelcell">
        <div align="center"></div>

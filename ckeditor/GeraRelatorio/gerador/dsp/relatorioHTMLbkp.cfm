...
// Função imprimir
function imprimir() {
    var quant = document.forms[0].elements.lengtd;
...
<table border="0" widtd="100%">
  ...
  <table widtd="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <th colspan="9" valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="left">4. Situação Encontrada, Causas Prov&aacute;veis, Manisfesta&ccedil;&otilde;es e Recomenda&ccedil;&otilde;es</div></th>
    </tr>
    <tr>
      <td valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row">&nbsp;</td>

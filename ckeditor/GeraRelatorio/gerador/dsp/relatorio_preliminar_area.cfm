...
<table border="0" width="95%">	  
  ...
  <tr>
    <td height="30%" class="labelcell"><p class="style2">Relat&oacute;rio Preliminar por &Aacute;rea - <cfoutput>#qryRelatorio.Ars_Sigla#</cfoutput></span></p> 
  </tr>
</table>
<table width="100%" border="0" cellspacing="4">
  ...
  <cfif Trim(UCASE(Tipo)) is ''> 
      ...
      <cfelse>	
	  <td width="37%" colspan="3" bgcolor="F5F5F5"><cfoutput>#qryRelatorio.TUN_Descricao#</cfoutput></td>   
  </cfif>
  </tr>
  <tr>
...
<cfoutput query="qryRelatorio" group="Grp_Codigo">  
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="F5F5F5"><div align="justify"><cfset coment = Replace(RIP_Comentario,"
","<BR>" ,"All")>#coment#</div></td>
 ...
 <tr>
  ...
  <tr>
    ...
    <th valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row">&nbsp;</th>
    <th width="32%" valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="right">Data/Hora de Emiss&atilde;o:</div></th>
    <td width="12%" valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="right"><cfoutput>#DateFormat(Now(),"DD/MM/YYYY")#</cfoutput> - <cfoutput>#TimeFormat(Now(),'HH:MM')#</cfoutput></div></td>
  </tr>
  <tr>
      <th colspan="4" valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><button type="button" onClick="imprimir()">Imprimir</button></th>
  </tr>
  <tr>

...
<table border="0" widtd="100%">
  ...
  <table widtd="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td colspan="6" valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="left"><span class="style2">Departamento de Controle Interno - DCINT </span></div></td>
    </tr>
    <tr>
      <td colspan="6" valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="left"> <span class="style2">Relat&oacute;rio de Acompanhamento </span>  </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <th colspan="9" valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="left">4. Situação Encontrada  e Orienta&ccedil;&otilde;es</div></th>
    </tr>
    <tr>
      <td valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row">&nbsp;</td>
...
<!---       <cfif val(grav) gt 46>
 ...
 <!---      <cfif sGrav eq 'Médio' or sGrav eq 'Alto'>
      ...
      <tr>
        <td valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row">&nbsp;</td>
        <th colspan="2" rowspan="2" valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="left">Item: #Itn_NumItem#</div>          <div align="left"></div></th>
        <td colspan="6" rowspan="2" valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="left">#Itn_Descricao#</div>          <div align="justify"></div></td>
        </tr>
      <tr>
...
","<BR>" ,"All")> 
         ...
         <tr>
           ...
           <td colspan="6" valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row">#RIP_Valor#</td>
         </tr>
        <tr>
        <td valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="left" class="labelcell"></div></td>
...
<!---               <cfloop query="qryAnexos">	
			  ...
			  <cfloop query="qryAnexos">               
				  <a target="_blank" href="../../../abrir_pdf_act.cfm?arquivo=#ListLast(qryAnexos.Ane_Caminho,'\')#">
				  <span class="link1">#ListLast(qryAnexos.Ane_Caminho,'\')#</span><br></a>
			  </cfloop>			  
         </div></td>
        </tr>  

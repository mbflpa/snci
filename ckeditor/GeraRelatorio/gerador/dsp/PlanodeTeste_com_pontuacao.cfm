...
<cffile action="Append" file="#slocal##sarquivo#" output='PLANO DE TESTE COM PONTUAÇÃO'>
</cfoutput>
...
<tr>
    ...
    <td><div align="right"><strong>Pontuação:</strong></div></td>
    <td width="12%"><div align="center"><strong>#Itn_Pontuacao#</strong></div></td>
    <td width="9%"><div align="right"><strong>Classificação:</strong></div></td>
    <td width="62%"><strong>&nbsp;#Itn_Classificacao#</strong></td>
    </tr>
<cffile action="Append" file="#slocal##sarquivo#" output='Relevância:;Pontuação:  #Itn_Pontuacao#;Classificação:  #Itn_Classificacao#'>		
	<tr>
    <td colspan="8"><div align="left"><strong>Composição da Pontuação</strong></div></td>
    </tr>
<cffile action="Append" file="#slocal##sarquivo#" output='Composição da Pontuação'>	
...
<cffile action="Append" file="#slocal##sarquivo#" output='ID;Peso;Descrição'>
  <cfloop query="rsComp">
  <tr>
...
<!---   <cfset ItnPreRelato = Replace(Itn_PreRelato,"
                  ...
                  <tr>
                    <td colspan="5"><div align="left"><strong>Pré-Relato</strong></div></td>
                  </tr>
      <tr>

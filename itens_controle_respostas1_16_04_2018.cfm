...
function anexar(){
  /*  if (document.form1.tipoUrg.value == ''){
       alert('Sr. Analista, falta fazer à Análise do Impacto da Oportunidade de Aprimoramento!')
	   return false;
   }*/
...
function validaForm(){
 if (document.form1.frmResp[5].checked){
    if(document.form1.cbData.value == ''){
      alert('Sr. Analista, informe a Área e a Data de previsão para a solução da Oportunidade de Aprimoramento!');
	  return false;
	}
  }
...
<input name="frmResp" type="radio" value="1" onClick="exibirArea(this.value);exibirOrgao(this.value);exibirData(this.value)" checked>
 ...
 <input type="radio" name="frmResp" value="8" onClick="exibirArea(this.value);exibirOrgao(this.value);exibirData(this.value)">
   ...
   <tr bgcolor="f7f7f7">
	 ...
	 <td height="38" valign="middle" bgcolor="#eeeeee"><span class="titulos">Oportunidade de Aprimoramento:</span></td>
	   <cfif qResposta.Pos_Parecer is 0>
	...
	<tr>
      <td valign="middle" bgcolor="eeeeee"><span class="titulos">Hist&oacute;rico:</span>
        <span class="titulos">Manifestação/An&aacute;lise da Auditoria</span><span class="titulos">:</span></td>
    ...
    <tr>
      <td height="107" valign="middle" bgcolor="eeeeee"><span class="titulos">Recomenda&ccedil;&otilde;es:</span></td>
	  ...
	  <textarea name="recomendacao" cols="120" rows="5" nome="recomendação" vazio="false" wrap="VIRTUAL" class="form" id="recomendacao"></textarea></td>
    </tr>
    <tr>
	...
	<tr>
	 ...
	 <td colspan="4" bgcolor="f7f7f7"><textarea name="observacao" cols="120" rows="5" nome="Observação" vazio="false" wrap="VIRTUAL" class="form" id="observacao"></textarea></td>
	</tr>
	<tr>

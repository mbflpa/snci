  ...
  if (frm.acao.value == 2)
     {
		...
		/*if(Right(frm.frmdtinic.value,4) != Right(frm.frmdtfim.value,4) && (frm.frmResp.value != 'N'; 'A'; 'R'; 'C') ){
		   alert("Informe o período dentro do mesmo ano!");
           return false;
	    }
*/        
       ...
       if(frm.frmResp.value == "")
          {
           ...
           <cfif isDefined("Form.acao") and Form.acao neq "">
             <cfif Form.acao is 1>
               <cflocation url="itens_se_controle_respostas.cfm?ckTipo=#ckTipo#&dtinicial=&dtfinal=&frmResp=">
    
             <cfelseif Form.acao is 2>
               <cflocation url="itens_se_controle_respostas.cfm?ckTipo=#ckTipo#&dtinicial=#frmdtinic#&dtfinal=#frmdtfim#&frmResp=#frmResp#">
             </cfif>
           </cfif>
...
<form action="itens_se_controle_respostas_ref.cfm" method="post" onSubmit="return valida_form();" enctype="multipart/form-data"  target="_blank" name="frmopc" >
      ...
      <tr>
        <td colspan="2"><p align="center" class="titulo1"><strong><br>
          PONTOS DE CONTROLE INTERNO POR SUPERINTENDÊNCIA ESTADUAL</strong></p>
            <p class="exibir"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
	  ...
	  <tr>
        <td>
         <span class="exibir">
          <strong><input name="ckTipo" type="radio" value="1" onClick="acao.value = 1; exibe(1)">Responder Itens da <cfoutput>#superEstUsuarioLogado#</cfoutput></strong>
         </span>
        </td>
	   </tr>

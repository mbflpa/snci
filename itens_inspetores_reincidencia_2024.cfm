...
<cfif isDefined("Form.acao") and #form.acao# is 'VALIDAR'>
	<cfoutput>
		...
		<cflocation url="itens_inspetores_avaliacao1_2024.cfm?Unid=#FORM.frmunid#&Ninsp=#FORM.frminsp#&Ngrup=#FORM.frmgrupo#&Nitem=#FORM.frmitem#&tpunid=#form.tpunid#&itnreincidentes=#form.itnreincidentes#&frminspreincidente=#FORM.frminspreincidente#&retornosn=#form.retornosn#&frmsituantes=#form.frmsituantes#&frmdescantes=#form.frmdescantes#">  
	</cfoutput> 
</cfif>
...
<cfoutput>
	 <cfquery datasource="#dsn_inspecao#">
        ...
        WHERE RIP_NumInspecao='#FORM.frminsp#' AND  RIP_Unidade='#FORM.frmunid#' AND RIP_NumGrupo=#FORM.frmgrupo# AND RIP_NumItem=#FORM.frmitem#
	  	...
	  	<cflocation url="itens_inspetores_avaliacao1_2024.cfm?Unid=#FORM.frmunid#&Ninsp=#FORM.frminsp#&Ngrup=#FORM.frmgrupo#&Nitem=#FORM.frmitem#&tpunid=#form.tpunid#&itnreincidentes=#form.itnreincidentes#&frmsituantes=#frmsituantes#&frmdescantes=#form.frmdescantes#"> 
</cfoutput>
</cfif>
...
WHERE (RIP_Unidade ='#nunid#' and (#grpitmsql#)  and Pos_Situacao_Resp in(1,6,7,17,22,2,4,5,8,20,15,16,18,19,23))
...
<table width="91%"  align="center" bordercolor="f7f7f7">
  ...
  <form name="form1" method="post" onSubmit="return validarform()" enctype="multipart/form-data" action="itens_inspetores_reincidencia_2024.cfm">

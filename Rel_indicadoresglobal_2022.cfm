...
<cfset auxcab = 'RESULTADO EM RELA��O � META ' & #ucase(cabec)#>
<cffile action="Append" file="#slocal##sarquivo#" output='#auxcab#'>
<cffile action="Append" file="#slocal##sarquivo#" output=';PRCI;;;SLNC;;;DGCI;;;Diferen�a em'>
<cffile action="Append" file="#slocal##sarquivo#" output='SE;Meta;Resultado;Parcial;Meta;Resultado;Parcial;Meta;Resultado;Parcial;Rela��o � Meta'>

...
<cfif IsDefined("form.reop") or IsDefined("url.reop")>
<!--- <cfparam  name="reop"  default=""> --->
<cfoutput>
<!---<cfif not IsDefined("dtinic")>--->
<cfquery name="rsItem" datasource="#dsn_inspecao#">
SELECT DISTINCT ParecerUnidade.Pos_NumItem, Inspecao.INP_DtInicInspecao, ParecerUnidade.Pos_Unidade, 
...
INNER JOIN Itens_Verificacao ON Itn_NumGrupo = Grp_Codigo and itn_ano = Grp_Ano and INP_Modalidade = Itn_Modalidade 
and (Und_TipoUnidade = Itn_TipoUnidade) AND Pos_NumItem = Itn_NumItem and right(INP_NumInspecao,4)= Itn_Ano
...
<!---  <tr>
  ...
  <tr class="exibir">
    ...
    <td width="102" height="16" bgcolor="eeeeee" align="center"><div align="center" class="titulos">In&iacute;cio Auditoria </div></td>
    ...
    <td width="180" bgcolor="eeeeee"><div align="center" class="titulos">Gravidade</div></td> 
  </tr>
...
<tr bgcolor="f7f7f7">
    	...
    	<td width="94" height="26" bgcolor="999999"><div align="center"><a href="itens_unidades_controle_respostas1_reop2.cfm?Unid=#rsItem.Pos_Unidade#&Ninsp=#rsItem.Pos_Inspecao#&Ngrup=#rsItem.Pos_NumGrupo#&DGrup=#rsItem.Grp_Descricao#&Nitem=#rsItem.Pos_NumItem#&Desc=#rsItem.Itn_Descricao#&Situacao=#rsItem.Pos_Situacao_Resp#&Reop=#rsItem.Rep_Codigo#" class="exibir">N&atilde;oRegularizada</a></div></td>
        <cfelseif rsItem.Pos_Situacao_Resp eq 1>
		<td width="102" height="26" bgcolor="FF3300"><div align="center"><a href="itens_unidades_controle_respostas1_reop2.cfm?Unid=#rsItem.Pos_Unidade#&Ninsp=#rsItem.Pos_Inspecao#&Ngrup=#rsItem.Pos_NumGrupo#&DGrup=#rsItem.Grp_Descricao#&Nitem=#rsItem.Pos_NumItem#&Desc=#rsItem.Itn_Descricao#&Situacao=#rsItem.Pos_Situacao_Resp#&Reop=#rsItem.Rep_Codigo#" class="exibir"><strong>RespostaAg&ecirc;ncia </strong></a></div></td>
        <cfelseif rsItem.Pos_Situacao_Resp eq 2> 
		<td height="26" bgcolor="FFFF00"><div align="center"><a href="itens_unidades_controle_respostas1_reop2.cfm?Unid=#rsItem.Pos_Unidade#&Ninsp=#rsItem.Pos_NumInspecao#&Ngrup=#rsItem.Pos_Grupo#&DGrup=#rsItem.Grp_Descricao#&Nitem=#rsItem.Pos_NumItem#&Desc=#rsItem.Itn_Descricao#&Situacao=#rsItem.Pos_Situacao_Resp#&Reop=#rsItem.Rep_Codigo#" class="exibir"><strong>Pendente Agência</strong></a></div></td>
        <cfelseif rsItem.Pos_Situacao_Resp eq 4>
		<cfset dtInicio = rsItem.INP_DtInicInspecao>
		<cfset dtFinal = rsItem.INP_DtInicInspecao>
		<td width="58" height="26" bgcolor="0000FF"><div align="center"><a href="itens_unidades_controle_respostas1_reop2.cfm?Unid=#rsItem.Pos_Unidade#&Ninsp=#rsItem.Pos_Inspecao#&Ngrup=#rsItem.Pos_NumGrupo#&DGrup=#rsItem.Grp_Descricao#&Nitem=#rsItem.Pos_NumItem#&Desc=#rsItem.Itn_Descricao#&Situacao=#rsItem.Pos_Situacao_Resp#&Reop=#rsItem.Rep_Codigo#" class="exibir"><strong>Pendente Órgão Subordinador</strong></a></div></td>
        <cfelseif rsItem.Pos_Situacao_Resp eq 3>
		<td width="68" height="26" bgcolor="333333"><div align="center"><a href="itens_unidades_controle_respostas1_reop2.cfm?Unid=#rsItem.Pos_Unidade#&Ninsp=#rsItem.Pos_Inspecao#&Ngrup=#rsItem.Pos_NumGrupo#&DGrup=#rsItem.Grp_Descricao#&Nitem=#rsItem.Pos_NumItem#&Desc=#rsItem.Itn_Descricao#&Situacao=#rsItem.Pos_Situacao_Resp#&Reop=#rsItem.Rep_Codigo#" class="exibir"><strong>Solucionado</strong></a></div></td>
	    </cfif>	  	

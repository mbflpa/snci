...
<cfif rotina eq 2>
		...
		<cfquery datasource="#dsn_inspecao#">
			delete from Andamento_Temp_Gilvan
...
<!--- rotina 1--->
		...
		<!--- VALIDAR PONTOS NA TABELA: Andamento_Temp_Gilvan  --->
		...
		<cfloop query="rsGRIT">
			...
			<cfif excSN eq 'S'>
				...
				<cfquery datasource="#dsn_inspecao#">
					UPDATE Andamento_Temp_Gilvan SET Andt_TipoRel = #AndtTipoRel#
		...
		<cfquery name="AndtArea" datasource="#dsn_inspecao#">
			...
			FROM Andamento_Temp_Gilvan INNER JOIN Areas ON Andt_Area = Ars_Codigo  
			WHERE Andt_AnoExerc ='#year(dtlimit)#' AND Andt_Mes = #month(dtlimit)# 
		</cfquery>

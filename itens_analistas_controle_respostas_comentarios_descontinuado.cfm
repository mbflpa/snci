...
<table width="80%" border="0" align="center">
	...
	<tr>
      <td colspan="4" bgcolor="#f7f7f7"><span class="titulo1">Relato da n&Atilde;o-conformidade</span></td>
	  </tr>
	<tr>
      <td colspan="4" bgcolor="#f7f7f7">&nbsp;</td>
	  </tr>
	<tr>
	  <td bgcolor="#eeeeee"><span class="titulos">N&ordm; Inspe&ccedil;&atilde;o:</span></td>
	  ...
	  <td width="18%" bgcolor="#eeeeee"><span class="titulos">Data da Inspeção:</span></td>
	...
	<tr>
	  <td colspan="4" bgcolor="#eeeeee"><span class="titulos">Irregularidade:</span></td> 
	 </tr>
	 <tr>
...
","<BR>" ,"All")>
	...
	<tr>
	  ...
	  <cfoutput>
      <td height="22" valign="top" class="exibir" bgcolor="eeeeee"><input type="button" value="Anexar arquivos" class="botao" onClick="window.open('itens_inspetores_transmitir_anexo.cfm?ninsp=#url.numero#&unid=#url.unidade#&ngrup=#url.numgrupo#&nitem=#url.numitem#&cktipo=#url.cktipo#&dtfim=#url.dtfim#&dtinic=#url.dtinic#&reop=#url.reop#','_self')"></td>
	  </cfoutput>
	</tr>
	<cfloop query="qAnexos">
		...
		<tr>
			...
			<cfoutput>
			<td bgcolor="f7f7f7"><input type="button" class="botao" value="Excluir" onClick="window.open('excluir_anexo.cfm?ninsp=#url.numero#&unid=#url.unidade#&ngrup=#url.numgrupo#&nitem=#url.numitem#&Ane_codigo=#qAnexos.Ane_Codigo#&cktipo=#url.cktipo#&dtfim=#url.dtfim#&dtinic=#url.dtinic#&reop=#url.reop#','_self')"> </td>
			</cfoutput>  
			</cfif>
	  </cfloop>	
	</tr>

...
<cfquery name="rsItem" datasource="#dsn_inspecao#">
	SELECT Usu_DR, Dir_Sigla, And_username, Usu_Apelido, Usu_Lotacao, Usu_LotacaoNome, And_NumInspecao, And_Unidade, Und_Descricao, TUN_Descricao, And_NumGrupo, Grp_Descricao, And_NumItem, Itn_Descricao, And_DtPosic, And_HrPosic, And_Situacao_Resp, STO_Descricao
FROM Situacao_Ponto 
...
INNER JOIN Itens_Verificacao ON (And_NumItem = Itn_NumItem) AND (Grp_Ano = Itn_Ano) AND (Grp_Codigo = Itn_NumGrupo)) ON STO_Codigo = And_Situacao_Resp
WHERE (And_DtPosic BETWEEN #url.dtInicio# AND #url.dtFinal#) and (And_Situacao_Resp in (3,10,12,13,15,16,19,23,24,28,29,30,31)) and (Usu_GrupoAcesso= 'INSPETORES' Or Usu_GrupoAcesso = 'GESTORES')
...
<cfelseif ucase(trim(qUsuario.Usu_GrupoAcesso)) neq 'GESTORMASTER'>
 AND (left(And_NumInspecao,2) in (#trim(qUsuario.Usu_Coordena)#)) 
	...
	ORDER BY Dir_Sigla, Usu_GrupoAcesso, Usu_Apelido, And_DtPosic, And_HrPosic, And_Unidade, And_NumInspecao, And_NumGrupo, And_NumItem
</cfquery>
</cfoutput>
...
<table width="1455" height="10%" border="1" align="center" cellspacing="0">
  ...
  <tr>
    <td height="10" colspan="14"><div align="center"><span class="titulo1">AN&Aacute;LISES  DAS MANIFESTA&Ccedil;&Otilde;ES</span></div>      
...
<tr>
    <td height="10" colspan="14" class="titulos">Total Geral.: <cfoutput>#rsItem.recordcount#</cfoutput><cfoutput>
  ...
  <cfset Andusername = ''>
	<cfoutput query="rsItem">  
	  ...
	  <tr bgcolor="##D9ECFA" class="titulosClaro">
	    <td colspan="14" bgcolor="##BFDAFC" class="exibir">Qtd. Reg.: #rsGestor.totaGestor#&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Analista: #Usu_Apelido#&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp; #Usu_LotacaoNome# &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	    </tr>
	  <tr bgcolor="##BFDAFC" class="titulosClaro">
	  <td width="54" class="exibir">Posi&ccedil;&atilde;o</td>
	    <td width="63" class="exibir">Hora</td>
...
<!--- 	<cfoutput query="rsItem"> --->
		  <tr class="exibir">
		  <cfset auxcol = dateformat(And_DtPosic,"dd/mm/yyyy")>
		...
		<tr><td colspan="14" align="center"><button onClick="window.close()" class="botao">Fechar</button></td>
	    </tr>
				<tr>
...
<cfset data = now() - 1>
    ...
    Query = rsItem,
	ColumnList = "Usu_DR,Dir_Sigla,And_username,Usu_Apelido,Usu_Lotacao,And_NumInspecao,And_Unidade,Und_Descricao,TUN_Descricao,And_NumGrupo,Grp_Descricao,And_NumItem,Itn_Descricao,And_DtPosic,And_HrPosic,And_Situacao_Resp,STO_Descricao",

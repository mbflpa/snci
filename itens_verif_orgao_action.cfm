...
<div align="center" class="exibir">
  ...
  <cfif rsGeral.RecordCount EQ 0>
      <strong class="exibir">Não existe informação para o período/Órgão informado</strong>
  </cfif> </div>
</div>

...
<!---Invoca o metodo  rsUsuarioLogado para retornar dados do usuário logado (rsUsuarioLogado)--->
 ...
 <!---Invoca o metodo  DescricaoPosArea para retornar a descrição da lotação do usuário logado (rsUsuarioLogado)--->       
       ...
       if(frm.frmResp.value == "")
          {
           ...
           <cfif isDefined("Form.acao") and Form.acao neq "">
             <cfif Form.acao is 1>
               <cflocation url="itens_subordinador_respostas_pendentes_subordinador_regional.cfm?ckTipo=#ckTipo#&dtinicial=&dtfinal=&frmResp=">
             <cfelseif Form.acao is 2>
               <cflocation url="itens_subordinador_respostas_pendentes_subordinador_regional_franqueadas.cfm">
             <cfelseif Form.acao is 3>
               <cflocation url="itens_subordinador_respostas_consulta_regional_ref.cfm">
             <cfelseif Form.acao is 4>
               <cflocation url="itens_subordinador_respostas_pendentes_subordinador_regional.cfm?ckTipo=#ckTipo#&dtinicial=#frmdtinic#&dtfinal=#frmdtfim#&frmResp=#frmResp#" addToken="false" statusCode="301">
            </cfif>
           </cfif>
...
<form action="itens_subordinador_respostas_pendentes_regional_ref.cfm" method="post" onSubmit="return valida_form();" enctype="multipart/form-data"  target="_blank" name="frmopc" >
      ...
      <tr>
        <td colspan="2"><p align="center" class="titulo1"><strong><br>
          PONTOS DE controle interno por &Oacute;rg&Atilde;o Subordinador Regional</strong></p>
            <p class="exibir"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <cfif rsGestoresAGF.recordcount gt 0 >
          <tr>
             ...
             <input name="ckTipo" type="radio" value="2" onClick="acao.value = 2; exibe(2)">Controle Rede Terceirizada</strong></span></td>
          </tr> 
	  </cfif>

        <tr>
          <td><span class="exibir"><strong>
            <input name="ckTipo" type="radio" value="3" onClick="acao.value = 3; exibe(3)">
            Relatório por Unidade </strong></span></td>
		</tr>
    
        <tr>
          <td><span class="exibir"><strong>
            <input name="ckTipo" type="radio" value="4" onClick="acao.value = 4; exibe(4)"> Consulta</strong></span></td>
		</tr>
      ...
      <tr>
        <tr>
        <td><div align="center">
          <input name="Confirmar" type="submit" class="exibir" id="Confirmar" value="Confirmar" onClick="xls();" >
        </div></td>
		</tr>
  </table>

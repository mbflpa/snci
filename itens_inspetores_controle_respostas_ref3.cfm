...
function valida_form() {
  ...
  if (frm.ckTipo[0].checked){
    ...
    if (frm.txtNum_Inspecao.value==''){
	  alert('Informe o Número da Inspeção!');
	  frm.txtNum_Matricula.focus();
	  return false;
	}
  }
  return true;
...
function desabilita_campos(){
  var frm = document.forms[0];
  if (frm.ckTipo[0].checked){
	frm.txtNum_Matricula.value='';
	frm.txtNum_Matricula.disabled=true;
  ...
  if (frm.ckTipo[1].checked){
	...
	frm.txtNum_Matricula.disabled=false;
	frm.txtNum_Matricula.focus();
  }
}
...
<cfinclude template="cabecalho.cfm"><br><br><br><br><br>
<p align="center" class="titulo1"><strong>Controle das manifesta&Ccedil;&Otilde;ES</strong></p>
</p><br><br>
<!--- Área de conteúdo   --->
	<form action="itens_inspetores_controle_respostas.cfm" method="Post" target="_blank" name="frmObjeto" onSubmit="return valida_form()">
      ...
      <tr>
        ...
        </strong><strong class="exibir">N&uacute;mero da matr&iacute;cula</strong></td>
      </tr>
	  <tr>
        <td width="106">&nbsp;</td>
        <td>&nbsp;</td>
	  ...
	  <tr>
        ...
        <td><strong>
        <div id="dNInsp" class="exibir">Digite o n&uacute;mero da Matr&iacute;cula: </div>
        </strong></td>
	  </tr>
      <tr>
       <td><div id="dDtFinal" class="exibir"><strong>Data Final:</strong></div></td>
        ...
        <td><input name="txtNum_Matricula" type="text" size="12" maxlength="10" tabindex="3" class="form"></td>
      </tr>
	  <tr>
       <td colspan="3">&nbsp;</td>
        </tr>

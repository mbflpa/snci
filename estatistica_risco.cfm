...
<table width="80%" border="0" align="center">
  <tr class="titulos">
    <td colspan="10">&nbsp;</td>
  <tr class="titulos">
    <td colspan="10"><div align="center"><span class="titulo1"><strong>ITENS PENDENTES - &Aacute;REAs</strong></span></div></td>
  <tr class="titulos">
    <td colspan="10">&nbsp;</td>
  <tr class="titulos">
    <td colspan="10">&nbsp;</td>
  ...
  <tr class="titulos">
    <td width="60%" bgcolor="eeeeee"><div align="center"><span class="style2">GER&Ecirc;NCIA</span></div></td>
  ...
  <tr class="exibir">
    <td bgcolor="eeeeee" class="style1">Total de itens pendentes </td>

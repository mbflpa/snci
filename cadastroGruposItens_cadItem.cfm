...
<!---                             <input type="checkbox"  name="checkPontuacaoCad" value="9" onclick="calcularPontuacaoCad();">TEM IMPACTO FINANCEIRO DIRETO = <strong>9 pontos</strong></input>
                            <div></div>
                            <input type="checkbox"  name="checkPontuacaoCad" value="4" onclick="calcularPontuacaoCad();">PODE ENSEJAR INDENIZAÇÃO/PENALIZAÇÃO À ECT/MULTAS CONTRATUAIS OU LEGAIS = <strong>4 pontos</strong></input>
                            <div></div>
...
--->
    ...
    var local = "parametros.cfm";
        ...
        CKEDITOR.replace('cadItemPreRelato', {
            width: '100%',
            height: 50,
            removePlugins: 'scayt',//corretor ortográfico
            disableNativeSpellChecker: false,
            toolbar: [
                ['Preview', 'Print', '-' ],
                [ 'Cut', 'Copy', 'Paste','PasteText', 'RemoveFormat',  '-', 'Undo', 'Redo', '-','Find','-','SelectAll'],

...
<cfif isDefined("form.acao") and "#form.acao#" eq 'cadItem'>
    ...
    <cfif '#rsItemExiste.recordcount#' eq 0>
        ...
        <cfloop list="#form.tipos#" index="i">       
            ...
            <cfset tipo = "#i#">          
            <cfif tipo neq 12>
                <cfset auxpontua = form.pontuacaoCalculadaCad>	
		    <cfelse>
				<cfset auxpontua = form.pontuacaoCalculadaCadAGF>	
		    </cfif>
            ...
            <cfif '#form.selModalidade#' eq 'todas'>
                ...
                <cfif tipo neq 12>
                    ...
                    <cfquery datasource="#dsn_inspecao#">
                        UPDATE Itens_Verificacao SET Itn_Pontuacao = #form.pontuacaoCalculadaCad#, Itn_PTC_Seq = '#form.checkpontuacaocadseq#', Itn_Classificacao = '#ClassifITEM#'
                ...
                <cfelse>
                    <cfquery datasource="#dsn_inspecao#">
                        UPDATE TipoUnidade_ItemVerificacao SET TUI_Pontuacao = #form.pontuacaoCalculadaCadAGF#, TUI_Pontuacao_Seq = '#form.checkpontuacaocadagfseq#', TUI_Classificacao = #ClassifITEM#'
                        WHERE TUI_TipoUnid = #tipo# AND TUI_Ano = '#form.selCadItemAno#' AND TUI_GrupoItem = '#form.selCadItemGrupo#' AND TUI_ItemVerif = #numItem# and TUI_Modalidade in(0,1)
                    </cfquery>
                    <cfquery datasource="#dsn_inspecao#">
                        UPDATE Itens_Verificacao SET Itn_Pontuacao = #form.pontuacaoCalculadaCadAGF#, Itn_PTC_Seq = '#form.checkpontuacaocadagfseq#', Itn_Classificacao = '#ClassifITEM#'
                        WHERE Itn_Modalidade In (0,1) AND Itn_Ano = '#form.selCadItemAno#' AND Itn_TipoUnidade = #tipo# AND Itn_NumGrupo = #form.selCadItemGrupo# AND Itn_NumItem = #numItem# 
                    </cfquery>						
                </cfif>					
            <cfelse>     
                ...
                <cfquery datasource="#dsn_inspecao#">
                    INSERT INTO Itens_Verificacao (Itn_Modalidade,Itn_NumGrupo,Itn_NumItem,Itn_Descricao,Itn_Orientacao,Itn_Situacao,Itn_DtUltAtu,Itn_UserName,Itn_ValorDeclarado,Itn_TipoUnidade,Itn_Ano,Itn_Amostra,Itn_Norma,Itn_ValidacaoObrigatoria,Itn_PreRelato,Itn_OrientacaoRelato,Itn_Manchete,Itn_ClassificacaoControle,Itn_ControleTestado,Itn_CategoriaControle,Itn_RiscoIdentificado,Itn_RiscoIdentificadoOutros,Itn_MacroProcesso,Itn_ProcessoN1,Itn_ProcessoN1NaoAplicar,Itn_ProcessoN2,Itn_ProcessoN3,Itn_ProcessoN3Outros,Itn_GestorProcesso,Itn_ObjetivoEstrategico,Itn_RiscoEstrategico,Itn_IndicadorEstrategico,Itn_Coso2013Componente,Itn_Coso2013Principios)
                    VALUES('#form.selModalidade#',#form.selCadItemGrupo#,#numItem#,'#form.cadItemDescricao#','#form.cadItemOrientacao#','D',CONVERT(DATETIME, getdate(), 103),'#qAcesso.Usu_Matricula#','#form.selCadItemValorDec#',#tipo#,#form.selCadItemAno#,'#form.cadItemAmostra#','#form.cadItemNorma#','#form.selCadItemValidObrig#','#form.cadItemPreRelato#','#form.cadItemOrientacaoRelato#','#form.cadItemManchete#','#form.itnclassificacontrole#','#form.controletestado#','#form.itncategoriacontrole#',#form.categoriarisco#,'#form.categoriariscooutros#',#form.macroprocesso#,#processon1#,'#form.macroprocesson1naoseaplica#',#processon2#,#processon3#,'#form.macroprocesson3outros#',#form.gestorprocesso#,'#form.itnobjetivoestrategico#','#form.itnriscoestrategico#','#form.itnindicadorestrategico#',#form.componentecoso#,#form.principioscoso#)                    
                </cfquery>	
                <!--- diferente de AGF --->	
                <cfif tipo neq 12>
                    <cfquery datasource="#dsn_inspecao#">
...
<!--- Inicio acordeon --->
                <div class="accordion" id="acordion-grpitm">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headUm">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#primeiro" aria-expanded="true" aria-controls="primeiro" style="color:#009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;">
                               <strong>ANO / GRUPO / VALOR DECLARADO / VALIDAÇÃO OBRIGATÓRIA</strong>
                            </button>
                            </h2>
                        <div id="primeiro" class="accordion-collapse collapse show" aria-labelledby="headUm" data-bs-parent="#acordion-grpitm">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headDois">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#segundo" aria-expanded="false" aria-controls="segundo" style="color:#009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;">
                            <strong>DESCRIÇÃO DO ITEM</strong>
                            </button>
                        </h2>
                        <div id="segundo" class="accordion-collapse collapse" aria-labelledby="headDois" data-bs-parent="#acordion-grpitm">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headTres">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#terceiro" aria-expanded="false" aria-controls="terceiro" style="color:#009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;">
                                <strong>MANCHETE</strong>
                            </button>
                        </h2>
                        <div id="terceiro" class="accordion-collapse collapse" aria-labelledby="headTres" data-bs-parent="#acordion-grpitm">
                            <div class="accordion-body">
                    ...
                    <!--- final terceiro --->      
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headQuatro">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#quarto" aria-expanded="false" aria-controls="quarto" style="color:#009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;">
                            <strong>COMO EXECUTAR/PROCEDIMENTOS ADOTADOS</strong>
                            </button>
                        </h2>
                        <div id="quarto" class="accordion-collapse collapse" aria-labelledby="headQuatro" data-bs-parent="#acordion-grpitm">
                            <div class="accordion-body">
                    ...
                    <!--- final quarto ---> 
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headNove">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#nono" aria-expanded="false" aria-controls="nono" style="color:#009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;">
                                <strong>AMOSTRA</strong>
                            </button>
                        </h2>
                        <div id="nono" class="accordion-collapse collapse" aria-labelledby="headNove"data-bs-parent="#acordion-grpitm">
                            <div class="accordion-body">
                    ...
                    <!---  final nono --->       
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headCinco">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#quinto" aria-expanded="false" aria-controls="quinto" style="color:#009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;">
                                <strong>NORMA</strong>
                            </button>
                        </h2>
                        <div id="quinto" class="accordion-collapse collapse" aria-labelledby="headCinco" data-bs-parent="#acordion-grpitm">
                            <div class="accordion-body">
                    ...
                    <!--- final quinto --->    
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headSeis">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#sexto" aria-expanded="false" aria-controls="sexto" style="color:#009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;">
                            <strong>RELATO MODELO</strong>
                            </button>
                        </h2>
                        <div id="sexto" class="accordion-collapse collapse" aria-labelledby="headSeis" data-bs-parent="#acordion-grpitm">
                            <div class="accordion-body">
                    ...
                    <!--- final sexto --->    
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headSete">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#setimo" aria-expanded="false" aria-controls="setimo" style="color:#009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;">
                               <strong>ORIENTAÇÕES UNIDADE/ÓRGÃO</strong>
                            </button>
                        </h2>
                        <div id="setimo" class="accordion-collapse collapse" aria-labelledby="headSete" data-bs-parent="#acordion-grpitm">
                            <div class="accordion-body">
                    ...
                    <!--- final setimo --->  
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headOito">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#oitavo" aria-expanded="false" aria-controls="oitavo" style="color:#009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;">
                            <strong>CONTROLE / RISCOS / PROCESSOS / ESTRATÉGIA / COSO-2013</strong>
                            </button>
                        </h2>
                        <div id="oitavo" class="accordion-collapse collapse" aria-labelledby="headOito" data-bs-parent="#acordion-grpitm">
                            <div class="accordion-body">
                                <div class="row">
                                    <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="row">
                                                <div id="macroprocesson3-outros"><textarea name="macroprocesson3outros" id="macroprocesson3outros" cols="100" rows="2" wrap="VIRTUAL" class="form-control" placeholder="Outros - Informar Descrição aqui."></textarea></div>
                                            </div>                                            
                                        </div>
                                        <div class="row"> 
                                            <div class="col">
                    ...
                    <!--- final oitavo --->                                                                                                                                                                 
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headUltimo">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#ultimo" aria-expanded="false" aria-controls="ultimo" style="color:#009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;">
                                <strong>PLANO DE TESTE</strong>
                            </button>
                        </h2>
                        <div id="ultimo" class="accordion-collapse collapse" aria-labelledby="headUltimo" data-bs-parent="#acordion-grpitm">
                            <div class="accordion-body">
                                <div align="left" style="margin-top:30px;margin-bottom:10px;padding:10px;border:1px solid #009;">
                                        ...
                                        <div id="totalDivCad">
                                            <div class="row"> 
                                                ...
                                                <div class="col">
                                                    ...
                                                    <br>                                                
                                                    <input type="text" id="pontuacaoCalculadaCad" name="pontuacaoCalculadaCad" readonly  size="3" class="form-control" style="color:#009;font-size:26px;text-align:center;background:transparent;" value="0"></strong></input>
                                                </div>
                                            </div>  
                                        </div>                                         
                                    </div>
                                    <div id="franquia">
                                            ...
                                            <div id="ptoagf" style="color:#009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:12px;">     
                                                <input type="radio" class="checkPontuacaoCadAGF" name="checkPontuacaoCadAGF" title="0" value="0" checked>&nbsp;&nbsp;Pontuação Inicial</input><br>
                                                <cfoutput query="rsPta">
                                                    <cfif rsPta.PTC_Franquia is 'S'>
                                                        <div class="row">
                                                            <label style="color:##009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:12px;">
                                                                <input  type="radio" class="checkPontuacaoCadAGF" title="#rsPta.PTC_Seq#" name="checkPontuacaoCadAGF" value="#rsPta.PTC_Valor#">&nbsp;&nbsp;#rsPta.PTC_Descricao# = <strong>#rsPta.PTC_Valor# pontos</strong></input> 
                                                            </label>
                                                        </div>
                                                    </cfif>
                                                </cfoutput>                                                       
                                            </div>
                                            <div id="totalDivCadAGF">
                                                <div class="row"> 
                                                    <div class="col">
                                                        <label style="color:#009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;">_____________________________________________________________________________________________________________________</label>
                                                    </div>                                    
                                                    <div class="col">
                                                        <label style="color:#009;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;"><strong>TOTAL:</strong></label>
                                                        <br>                                                
                                                        <input type="text" id="pontuacaoCalculadaCadAGF" name="pontuacaoCalculadaCadAGF" readonly  class="form-control" size="3" style="color:#009;font-size:26px;text-align:center;background:transparent;" value="0"></strong></input>
                                                    </div>
                                                </div> 
                                            </div>
                                    </div>

...
<cfquery name="rsStatus" datasource="#dsn_inspecao#">
  ...
  FROM Situacao_Ponto where (STO_Status = 'A') and (STO_Codigo not in (0,3,10,11,12,13,14,24,27,29,30,51)) order by Sto_Sigla
</cfquery>
<!---Fim - Marcelo--->
<!--- =========================== --->
...
<!--- Área de conteúdo   --->
	<form action="itens_analistas_controle_respostas.cfm" method="get" target="_blank" name="frmObjeto" onSubmit="return valida_form()">

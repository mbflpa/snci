<cfcomponent>
	...
	<cffunction name="salvarPosic"   access="remote" hint="salva a manifestação de qualquer usuário">
		...
		<cfquery datasource="#dsnSNCI#" name="rsexistegestor">
			...
			WHERE FAC_Avaliacao = convert(varchar,'#form.FACAVALIACAO#') and FAC_Matricula = '#form.facmatricula#'
		</cfquery>
		...
		<cfquery datasource="#dsnSNCI#" name="rsexisteaval">
		   ...
		   where FACA_Avaliacao = '#form.FACAVALIACAO#' and 
		...
		<cfif grpacesso neq 'INSPETORES'>
			...
			<cfelse>
				...
				<cfquery datasource="#dsnSNCI#">
					...
					where FAC_Avaliacao = '#form.FACAVALIACAO#' and FAC_Matricula='#form.FACMATRICULA#' and FAC_Unidade = '#form.FACUNIDADE#'		
				</cfquery>		
			</cfif>
		</cfif>

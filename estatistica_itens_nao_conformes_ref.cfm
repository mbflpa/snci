...
<form action="estatistica_itens_nao_conformes.cfm" method="post" target="_blank">
      ...
      <tr>
        <td colspan="3"><p align="center" class="titulo1"><strong> estat&Iacute;stica dos pontos de auditoria</strong></p>
        </td>
      </tr>
	 	    <tr>
	 	      <td colspan="3">&nbsp;</td>
            ...
            <tr>
              <td width="336"><span class="exibir"><strong>
      ...
      <td width="113"><input name="Submit2" type="submit" class="botao" value="Confirmar"></td>
      <td width="425">&nbsp;</td>
  </table>
</form>

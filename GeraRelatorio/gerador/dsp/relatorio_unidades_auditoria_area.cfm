...
<cfinvoke component="#vRelatorio#.GeraRelatorio.gerador.ctrl.controller" 
	method="geraRelatorioUnidadearea" returnvariable="qryRelatorio"></cfinvoke>	
...
","<BR>" ,"All")>
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="F5F5F5"><div align="justify"><cfif qryRelatorio.Pos_Situacao_Resp eq 5>Pendente Área</cfif>

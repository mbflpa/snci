    ...
    <cfquery name="rsChecklistFiltrado" datasource="#dsn_inspecao#">
        SELECT TUI_Modalidade,TUI_TipoUnid,TUI_Ativo,TUI_Ano,TUI_GRUPOITEM,TUI_ITEMVERIF,TUN_Descricao,Grp_Descricao,Itn_Descricao,Itn_Orientacao,Itn_ValorDeclarado,Itn_Amostra,Itn_Norma
        ...
        ORDER BY TUN_Descricao,TUI_Modalidade,TUI_Ativo,Itn_ValorDeclarado,TUI_GRUPOITEM,TUI_ITEMVERIF  
    </cfquery>
            ...
            <table widtd="100%" border="0" cellspacing="4">
               <thead>
                ...
                <cfoutput query="rsChecklistFiltrado" group="TUI_GRUPOITEM">
                    <cfif TUI_Modalidade eq 0> 
                        <cfset modal = 'PRESENCIAL'>
                    <cfelseif TUI_Modalidade eq 1>
                        <cfset modal = 'A DISTÂNCIA'>
                    <cfelse>
                        <cfset modal = 'PRESENCIAL e A DISTÂNCIA'>
                    </cfif>	  
                    <cfif TUI_Ativo eq 0> 
                        <cfset situ = 'DESATIVADO'>
                    <cfelse>
                        <cfset situ = 'ATIVADO'>
                    </cfif>	    
                    <cfif Itn_ValorDeclarado eq 'S'> 
                        <cfset vlrdec = 'SIM'>
                    <cfelse>
                        <cfset vlrdec = 'NÃO'>
                    </cfif>	                
                    <cfif auxtipound neq TUI_TipoUnid or auxmodal neq TUI_Modalidade or auxativo neq TUI_Ativo or auxvlrdec neq Itn_ValorDeclarado>
                        <tr>
                            <td colspan="6" valign="top" bordercolor="999999" bgcolor="" scope="row"><div align="left"> <span class="style2"  style="color:##053c5e;">Tipo de unidade: <strong>#rsChecklistFiltrado.TUN_Descricao#</strong></span> </div> </td>
                        </tr>
                        <cffile action="Append" file="#slocal##sarquivo#" output='Tipo de Unidade:;#rsChecklistFiltrado.TUN_Descricao#'>
                        <tr>
                            <td colspan="6" valign="top" bordercolor="999999" bgcolor="" scope="row"><div align="left"> <span class="style2"  style="color:##053c5e;">Situação: <strong>#situ#</strong></span></div> </td>
                        </tr> 
                        <cffile action="Append" file="#slocal##sarquivo#" output='Situação:;#situ#'>		                        			
                        <tr>
                            <td colspan="6" valign="top" bordercolor="999999" bgcolor="" scope="row"><div align="left"> <span class="style2"  style="color:##053c5e;">Modalidade: <strong>#modal#</strong></span></div> </td>
                        </tr> 
                        <cffile action="Append" file="#slocal##sarquivo#" output='Modalidade:;#modal#'>		
                        
                        <tr>
                            <td colspan="6" valign="top" bordercolor="999999" bgcolor="" scope="row"><div align="left"> <span class="style2"  style="color:##053c5e;">Valor declarado: <strong>#vlrdec#</strong></span></div> </td>
                        </tr> 
                        <cffile action="Append" file="#slocal##sarquivo#" output='Valor declarado:;#vlrdec#'>	                        		       
                        <tr>
                            <td  valign="top" bordercolor="999999" bgcolor="" scope="row">&nbsp;</td>
                        </tr>    
                        <cfset auxtipound = TUI_TipoUnid> 
                        <cfset auxmodal = TUI_Modalidade>
                        <cfset auxativo = TUI_Ativo>
                        <cfset auxvlrdec = Itn_ValorDeclarado>
                    </cfif>              
                    <tr> 

...
<table border="0" width="95%">
 <cfif qryRelatorio.recordcount is 0>
  ...
  <tr>
    <td height="30%" class="labelcell"><p class="style2">Relat&oacute;rio Preliminar de Auditoria - <span class="style2"><cfoutput>#siglaDR#</cfoutput></span></p>
    </td>
  </tr>
</table>
  ...
  <tr>
    ...
    <th width="21%" valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="left">Diretoria:</div></th>
...
<cfoutput query="qryRelatorio" group="Grp_Codigo">  
  ...
  <tr>
    ...
    <td colspan="3" bgcolor="F5F5F5">#Grp_Descricao#</td>
  </tr> 
  <cfoutput> 
   <cfset grav = 0>
  ...
  <tr>
    <th valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row">&nbsp;</th>
    <th with="15%" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="left">N&ordm; da Auditoria:</div></th>
...
<tr>
  ...
  <cfoutput>
    <cfloop query="qryCoordenadores"> 	  	  
     <tr>
       ...
       <td width="8%" valign="top" bordercolor="999999" bgcolor="F5F5F5"><div align="center">#(Left(INP_Coordenador,1) & '.' & Mid(INP_Coordenador,2,3) & '.' & Mid(INP_Coordenador,5,3) & '-' & Right(INP_Coordenador,1))#</div></td>
       <td width="28%" valign="top" bordercolor="999999" bgcolor="F5F5F5">#Fun_Nome#</td>
  ...
  <cfoutput>
    <cfloop query="qryInspetores"> 	  	  
     <tr>
       <td valign="top" bordercolor="999999" bgcolor="F5F5F5">&nbsp;</td>
       <th valign="top" bordercolor="999999" bgcolor="F5F5F5">&nbsp;</th>
       <td width="8%" valign="top" bordercolor="999999" bgcolor="F5F5F5"><div align="center">#(Left(IPT_MatricInspetor,1) & '.' & Mid(IPT_MatricInspetor,2,3) & '.' & Mid(IPT_MatricInspetor,5,3) & '-' & Right(IPT_MatricInspetor,1))#</div></td>
       <td width="28%" valign="top" bordercolor="999999" bgcolor="F5F5F5">#Fun_Nome#</td>
       <td valign="top" bordercolor="999999" bgcolor="F5F5F5"> <div align="center">----------------------------</div></td>
     </tr>
    </cfloop>
  ...
  <tr>
    ...
    <th width="21%" valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="left">&nbsp;</div></th>
    <th colspan="3" valign="top" bordercolor="999999" bgcolor="F5F5F5" scope="row"><div align="left">&nbsp;</div></th>
   </tr>  
   <tr>

...
<p align="center">
 ...
 <form action="GeraRelatorio/gerador/dsp/relatorio_auditoria_area.cfm" method="Post" name="frmHtml" target="_blank">
      <table width="67%" align="center"><br>
        <br>
        <tr>
          <td colspan="5">&nbsp;</td>
        </tr>
        <tr>
        <td colspan="5"><p align="center" class="titulo1"><strong> Relat&Oacute;rio de Acompanhamento por &Aacute;rea</strong></p>
            </td>
      </tr> 
	 	 ...
	 	 <tr>
	 	    ...
	 	    <tr>
	 	      <td width="110">&nbsp;</td>
        <td width="138"><span class="exibir"><strong>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><span class="exibir"><strong>&Aacute;rea : </strong></span></td>
      ...
      <tr>
        ...
        <td><span class="exibir"> <span class="exibir">
      ...
      <td width="178"><input name="Submit2" type="submit" class="botao" value="Confirmar"></td>
      <td width="177">&nbsp;</td>
   </table>
</form>

...
<cfif IsDefined("FORM.MM_UpdateRecord") AND FORM.MM_UpdateRecord EQ "form1" And IsDefined("FORM.acao") And Form.acao is "Salvar2">
  ...
  , Pos_Parecer=
    ...
    , Pos_VLRecuperado='#Replace(FORM.VLRecuperado,",",".")#'
    </cfif>
...
function exibirValor(vlr){
  if (vlr==3){
    ...
    alert('Sr. Inspetor, informe o valor recuperado, Exemplos: 1185,40; 0,07');
  } else {
    ...
    <cfif isDefined("Session.E01.abertura")>
      ...
      <tr bgcolor="f7f7f7">
        <td colspan="5" height="22" valign="middle" class="exibir">Situa&ccedil;&atilde;o:&nbsp;&nbsp;
            ...
            <input name="frmResp" type="radio" value="2" <cfif Session.E01.frmResp is '2'>checked</cfif> onClick="exibirData(this.value);exibirAreaCS(this.value);exibirValor(this.value);exibirArea(this.value)">
              Pendente Unidade</span></label>
            <label><span class="style4">
            <input name="frmResp" type="radio" value="4" <cfif Session.E01.frmResp is '4'>checked</cfif> onClick="exibirData(this.value);exibirAreaCS(this.value);exibirValor(this.value);exibirArea(this.value)">
              Pendente de Órgão Subordinador</span></label>
            <label><span class="style4">
            <input type="radio" name="frmResp" value="5" <cfif Session.E01.frmResp is '5'>checked</cfif> onClick="exibirArea(this.value);exibirAreaCS(this.value);exibirValor(this.value);exibirData(this.value)">
              Pendente de Área</span></label>
            <label><span class="style4">
            <input type="radio" name="frmResp" value="8" <cfif Session.E01.frmResp is '8'>checked</cfif> onClick="exibirData(this.value);exibirAreaCS(this.value);exibirValor(this.value);exibirArea(this.value)">
              Corporativo SE</span></label>
            <label><span class="style4">
            <input type="radio" name="frmResp" value="9" <cfif Session.E01.frmResp is '9'>checked</cfif> onClick="exibirData(this.value);exibirAreaCS(this.value);exibirValor(this.value);exibirArea(this.value)">
              Corporativo CS</span></label></td>
      </tr>
      <tr bgcolor="f7f7f7">
        <td colspan="5" height="22" valign="middle" class="exibir">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <label><span class="style4">
            <input type="radio" name="frmResp" value="3" <cfif session.E01.frmresp is '3'>checked</cfif> onClick="exibirData(this.value);exibirArea(this.value);exibirAreaCS(this.value);exibirValor(this.value)">
              Solucionado</span></label>
            <label><span class="style4">
            <input type="radio" name="frmResp" value="10" <cfif Session.E01.frmResp is '10'>checked</cfif> onClick="exibirData(this.value);exibirAreaCS(this.value);exibirValor(this.value);exibirArea(this.value)">
              Ponto Suspenso</span></label>
            <label><span class="style4">
            <input type="radio" name="frmResp" value="13" <cfif Session.E01.frmResp is '13'>checked</cfif> onClick="exibirData(this.value);exibirAreaCS(this.value);exibirValor(this.value);exibirArea(this.value)">
              Orientação Cancelada</span></label>
            <label><span class="style4">
            <input type="radio" name="frmResp" value="12" <cfif Session.E01.frmResp is '12'>checked</cfif> onClick="exibirData(this.value);exibirAreaCS(this.value);exibirValor(this.value);exibirArea(this.value)">
      ...
      <tr bgcolor="f7f7f7">
        <td colspan="5" height="22" valign="middle" class="exibir">Situa&ccedil;&atilde;o:&nbsp;&nbsp;
            <label><span class="style4">
            <input name="frmResp" type="radio" value="2" onClick="exibirData(this.value);exibirArea(this.value);exibirValor(this.value);exibirAreaCS(this.value)">
              Pendente Unidade</span></label>
            <label><span class="style4">
            <input name="frmResp" type="radio" value="4" onClick="exibirData(this.value);exibirArea(this.value);exibirValor(this.value);exibirAreaCS(this.value)">
              Pendente de Órgão Subordinador</span></label>
            <label><span class="style4">
            <input type="radio" name="frmResp" value="5" onClick="exibirArea(this.value);exibirData(this.value);exibirValor(this.value);exibirAreaCS(this.value)">
              Pendente de Área</span></label>
            <label><span class="style4">
            <input type="radio" name="frmResp" value="8" onClick="exibirData(this.value);exibirArea(this.value);exibirValor(this.value);exibirAreaCS(this.value)">
              Corporativo SE</span></label>
            <label><span class="style4">
            <input type="radio" name="frmResp" value="9" onClick="exibirData(this.value);exibirArea(this.value);exibirValor(this.value);exibirAreaCS(this.value)">
              Corporativo CS</span></label></td>
      </tr>
      <tr bgcolor="f7f7f7">
        <td colspan="5" height="22" valign="middle" class="exibir">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <label><span class="style4">
            <input type="radio" name="frmResp" value="3" onClick="exibirValor(this.value);exibirData(this.value);exibirArea(this.value);exibirAreaCS(this.value)">
              Solucionado</span></label>
            <label><span class="style4">
            <input type="radio" name="frmResp" value="10" onClick="exibirData(this.value);exibirArea(this.value);exibirValor(this.value);exibirAreaCS(this.value)">
              Ponto Suspenso</span></label>
            <label><span class="style4">
            <input type="radio" name="frmResp" value="13" onClick="exibirData(this.value);exibirArea(this.value);exibirValor(this.value);exibirAreaCS(this.value)">
              Orientação Cancelada</span></label>
            <label><span class="style4">
            <input type="radio" name="frmResp" value="12" onClick="exibirData(this.value);exibirArea(this.value);exibirValor(this.value);exibirAreaCS(this.value)">
              Ponto Improcedente</span></label></td>
      </tr>
      <tr>
        <td colspan="5">&nbsp;</td>
	...
	<cfif qVerificaPonto.RecordCount Neq 0>
       ...
       <cfif qResposta.Pos_VLRecuperado eq ''>
          <td colspan="2" rowspan="2" class="exibir"><div id="dValor">Valor Recuperado:&nbsp;&nbsp;
               <input name="VLRecuperado" class="form" type="text" size="20" onkeyup="somenteNumeros(this)">
          </div></td>
       <cfelse>
          <cfoutput>
            <td colspan="2" rowspan="2" class="exibir">Valor Recuperado:&nbsp;&nbsp;
                <input name="VLRecuperado" value="#Replace(numberformat(qResposta.Pos_VLRecuperado,'999999.00'),'.',',')#" class="form" type="text" size="20"></td>
          </cfoutput>
       </cfif>
	 <cfelse>
      ...
      <tr>
        <td bgcolor="eeeeee" align="center"><span class="titulos">Opini&atilde;o da Equipe de Controle Interno:</span></td>
        <td colspan="4" bgcolor="f7f7f7"><textarea name="observacao" cols="200" rows="25" nome="Observacao" vazio="false" wrap="VIRTUAL" class="form" id="observacao"></textarea></td>
      </tr>
      <tr>
        <td colspan="5">&nbsp;</td>
      </tr>

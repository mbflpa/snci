...
<form action="estatistica_itens_nao_conformes_reop.cfm" method="post" target="_blank">
      ...
      <tr>
        <td colspan="3"><p align="center" class="titulo1"><strong>Pontos PENDENTES - &Oacute;rg&Atilde;o Subordinador </strong></p>
        </td>
      </tr>
	 	    <tr>
	 	      <td colspan="3">&nbsp;</td>
            ...
            <tr>
              <td width="342"><span class="exibir"><strong>

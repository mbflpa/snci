...
<p align="center">
 ...
 <form action="GeraRelatorio/gerador/dsp/relatorio_preliminar_DR.cfm" method="Post" name="frmHtml" target="_blank">
      <table width="63%" align="center"><br>
        ...
        <tr>
        <td colspan="5"><p align="center" class="titulo1"><strong> Relat&Oacute;rio PRELIMINAR por DR</strong></p>
            <p class="exibir"></td>
      </tr> 

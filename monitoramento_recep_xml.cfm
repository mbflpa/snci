...
//==========
function mostrar(x){
 var a = x.substring((x.length - 14), x.length);
...
<form name="frm1" action="monitoramento_recep_xml1.cfm?flush=true" enctype="multipart/form-data" method="post"  onSubmit="return troca(arquivo.value,numero_inspecao.value);">
...
<table width="100%" border="0" align="center"><br><br><br><br><br>
  ...
  <tr>
   ...
   <td><input name="numero_inspecao" type="text" class="form" size="30" maxlength="14" readonly="Yes"></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>

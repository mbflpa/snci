...
<!--- Verificação para acessar o relatorio de inspeção em diferentes perfis --->
...
<table width="90%" border="0" align="center">
	...
	<tr>
		<td colspan="5" class="titulos"><div align="center">Quantidade de pontos do Relat&oacute;rio de Avalia&ccedil;&atilde;o de Controle Interno com Situação Encontrada: <font class="red_titulo"><cfoutput>#numlinhas#</cfoutput></font></div></td>
	</tr>
<!---           <tr>

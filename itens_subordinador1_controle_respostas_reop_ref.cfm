      ...
      <tr>
        <td colspan="4"><p align="center" class="titulo1">&nbsp;</p>
          ...
          <p align="center" class="titulo1">&nbsp;</p>
	 	    ...
	 	    <tr>
	 	      <td colspan="3"><div align="left"><strong class="exibir">Pesquisando por:&nbsp;&nbsp;&nbsp;&nbsp;</strong></div></td>
        </tr>
	 	    <tr>
	 	      <td colspan="3">&nbsp;</td>
        </tr>		   
            <tr>
              ...
              <td colspan="2"><span class="exibir">
                <input name="dtinic" type="text" vazio="false" nome="Data Inicial" tabindex="1" size="12" maxlength="10" class="form" onKeyDown="Mascara_Data(this)" onKeyPress="numericos()">
              </span></td>
            </tr>
            <tr>
              <td><span class="exibir"><strong>Data Final: </strong></span></td>
              <td colspan="2"><span class="exibir">
                <input name="dtfinal" type="text" tabindex="2" size="12" vazio="false" nome="Data Final" maxlength="10" class="form" onKeyDown="Mascara_Data(this)" onKeyPress="numericos()">
              </span> </td>
            </tr>          
      <tr>

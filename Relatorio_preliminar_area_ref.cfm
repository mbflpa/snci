...
<p align="center">
 ...
 <form action="GeraRelatorio/gerador/dsp/relatorio_preliminar_area.cfm" method="Post" name="frmHtml" target="_blank">
      <table width="67%" align="center"><br>
        ...
        <tr>
        <td colspan="5"><p align="center" class="titulo1"><strong> Relat&Oacute;rio  PRELIMINAR por &Aacute;rea</strong></p>
          </td>
      </tr> 

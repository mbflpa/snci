   ...
   UPDATE Metas SET Met_DGCI_AcumPeriodo = #MetDGCIAcumPeriodo# WHERE Met_Codigo='#url.dr#' and Met_Ano = #YEAR(dtlimit)# and Met_Mes = #aux_mes#
	  ...
	  <tr>
		...
		<tr>
          <td width="51%">
            <div align="center">
              <input name="Voltar" type="button" class="botao" value="Voltar" onClick="window.open('dgci_ref.cfm','_self')" disabled>
            </div></td>
          <td width="49%">
            <div align="center">
...
<!--- 				<tr>
          <td width="51%">
            <div align="center">
              <input name="Voltar" type="button" class="botao" value="Voltar" onClick="window.open('dgci_ref.cfm?cabec=s','_self')">
            </div></td>
          <td width="49%">
            <div align="center">

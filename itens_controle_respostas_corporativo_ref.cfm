...
<form action="itens_controle_respostas_corporativo.cfm" method="post">
      <table width="60%" align="center"><br><br>
        <tr>
          <td colspan="5">&nbsp;</td>
        </tr>
        <tr>
        <td colspan="5"><p align="center" class="titulo1"><strong>  Pontos Corporativos por &Aacute;REA </strong></p>
            <p class="exibir"></td>
      </tr> 

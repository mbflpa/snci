...
<cfquery name="rsItem" datasource="#dsn_inspecao#">
  SELECT INP_DtInicInspecao, Pos_Unidade, INP_Responsavel, Und_Descricao, Pos_Inspecao, Pos_NumGrupo, Pos_NumItem, pos_dtultatu, Itn_Descricao, Grp_Descricao, Pos_Situacao_Resp, Pos_Parecer, STO_Codigo, STO_Sigla, STO_Cor, STO_Descricao
  FROM ParecerUnidade 
  INNER JOIN Unidades 

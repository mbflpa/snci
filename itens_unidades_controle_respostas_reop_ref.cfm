...
<!---Invoca o metodo  rsUsuarioLogado para retornar dados do usuário logado (rsUsuarioLogado)--->
 ...
 <!---Invoca o metodo  DescricaoPosArea para retornar a descrição da lotação do usuï¿½rio logado (rsUsuarioLogado)--->       
...
<cfquery name="rsGestoresAGF" datasource="#dsn_inspecao#">
    ...
    WHERE Unidades.Und_TipoUnidade=12 AND (Areas.Ars_Codigo = '#rsUsuarioLogado.CodigoLotacao#' OR  Unidades.Und_CodReop = '#rsUsuarioLogado.CodigoLotacao#')
</cfquery> 
       ...
       if(frm.frmResp.value == "")
          {
           ...
           <cfif isDefined("Form.acao") and Form.acao neq "">
             <cfif Form.acao is 1>
               <cflocation url="itens_unidades_controle_respostas_reop.cfm?ckTipo=#ckTipo#&dtinicial=&dtfinal=&frmResp=">
             <cfelseif Form.acao is 2>
               <cflocation url="itens_subordinador_controle_respostas_reop_ref.cfm">
             <cfelseif Form.acao is 3>
               <cflocation url="itens_unidades_controle_respostas_reop.cfm?ckTipo=#ckTipo#&dtinicial=#frmdtinic#&dtfinal=#frmdtfim#&frmResp=#frmResp#">
             </cfif>
           </cfif>
...
//permite digitação das teclas numï¿½ricas (48 a 57, 96 a 105), Delete e Backspace (8 e 46), TAB (9) e ESC (27)
...
<form action="itens_unidades_controle_respostas_reop_ref.cfm" method="post" onSubmit="return valida_form();" enctype="multipart/form-data"  target="_blank" name="frmopc" >
      ...
      <tr>
        <td colspan="2"><p align="center" class="titulo1"><strong><br>
          PONTOS DE controle interno por &Oacute;G&Atilde;O Subordinador</strong></p>
            <p class="exibir"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
	  ...
	  <tr>
        ...
        <tr>
          <td><span class="exibir"><strong>
            <input name="ckTipo" type="radio" value="2" onClick="acao.value = 2; exibe(2)">
            Relat&oacute;rio por Unidade </strong></span></td>
		</tr>
    
        <tr>
          <td><span class="exibir"><strong>
            <input name="ckTipo" type="radio" value="3" onClick="acao.value = 3; exibe(3)"> Consulta</strong></span></td>
		</tr>
        
		<tr>
          <td ><div id="consultaSitData" >
             <span class="exibir"><strong>&nbsp;&nbsp;&nbsp;Situa&ccedil;&atilde;o:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></span>
             <select name="frmResp" class="form" id="frmResp" >
                 <option value="" selected>Selecione uma Situa&ccedil;&atilde;o</option>
                <option value="N">N&Atilde;O SOLUCIONADOS</option>
                <option value="S">SOLUCIONADOS</option>
                <option value="A">APURA&Ccedil;&Atilde;O</option> 
                <cfif rsGestoresAGF.recordcount gt 0 >

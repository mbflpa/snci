			...
			<div class="container-fluid">
				...
				<div class="row mb-2" style="margin-bottom:0px!important;">
					<div class="col-sm-12">
						...
						<cfset ano = year(now())>
						<cfoutput><h5 style="color:##0083ca;">Resutado dos Indicadores do órgão #application.rsUsuarioParametros.pc_org_sigla#: <strong>#mes#/#ano#</strong></h5></cfoutput>
				...
				<div id="divTabsIndicadores" >
					...
					<div class="card-body">
						<div class="tab-content" id="myTabsContent" >
							<div class="tab-pane fade show active" id="divCardDGCIacompDiarioContent" role="tabpanel" aria-labelledby="tabCardDGCIacompDiario" style="width:800px;">
								<div style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
									<div id="divCardDGCIacompDiario" style="width:800px;"></div>
									<div id="divCesta" style="width:740px;border: 2px solid #9f9b9b; border-radius: 10px; padding-left: 20px;padding-right: 20px;padding-bottom:5px; margin-top:10px; display: none; flex-direction: column; justify-content: center; align-items: center;">
										<!-- Ícone de seta da Font Awesome -->
										<div style="position: relative; top: -19px;">
											<i class="fas fa-arrow-up" style="font-size:20px;color:#9f9b9b"></i>
										</div>

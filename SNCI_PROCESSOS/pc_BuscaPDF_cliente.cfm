...
<head>
    <meta charset="UTF-8">
    <title>Busca PDF (Versão Cliente)</title>
    ...
    <style>
        ...
        /* Novo estilo para resultado em tempo real */
        .live-result {
        ...
        /* Indicador de progresso para cada documento */
        .document-progress {
            height: 3px;
            background-color: #e9ecef;
            border-radius: 2px;
        ...
        .memory-optimal { color: #28a745; }
        .memory-warning { color: #ffc107; }
        .memory-danger { color: #dc3545; }
        ...
        /* Animação de destaque para novos resultados */
        @keyframes highlightNew {
            0% { background-color: rgba(0, 131, 202, 0.2); }
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" data-panel-auto-height-mode="height">
        ...
        <div class="content-wrapper">
            ...
            <div class="search-header text-center">
                <div class="container-fluid">
                    ...
                    <span class="badge badge-light">Versão Cliente - PDF.js</span>
                </div>
            </div>
                    ...
                    <div class="card search-card" id="resultsCard" style="display:none;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center" id="searchLoading" style="display:none; margin-bottom: 30px;">
                                ...
                                <!-- Monitor de uso de memória (mantido conforme solicitado) -->
                                <div class="text-center mt-2">
                                    <span class="memory-usage" id="memoryUsage">Memória: --</span>
                                </div>
                            </div>
    ...
    <script src="dist/js/snciProcessos_buscaPDF_cliente.js"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#searchFaqForm').on('submit', function(e) {
                ...
                // A lógica de busca está no arquivo JavaScript separado
            });

...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" data-panel-auto-height-mode="height">
                    ...
                    <div class="card search-card" id="resultsCard" style="display:none;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center" id="searchLoading" style="display:none;">
                                <div class="document-scanner-container" style="height: 100px;">
                                    <svg class="document-scanner-svg" viewBox="0 0 500 150" xmlns="http://www.w3.org/2000/svg" style="max-width: 490px;">
                                        <defs>
                                            <g id="pdf-document">
                                        ...
                                        <rect class="scanner-area" x="220" y="35" width="70" height="90" rx="5" ry="5" stroke-dasharray="4,2">
                                            <animate attributeName="opacity" from="0" to="1" dur="0.8s" fill="freeze" begin="0s"/>
                                        </rect>
                                        
                                        <!-- Documento com animação sequencial - não usar begin="indefinite" -->
                            ...
                            <div id="realTimeResults" class="mt-4" style="display:none;">
                                ...
                                <div id="realTimeResultsList" class="search-results text-left"></div>
                            </div>
    ...
    <!-- Scripts necessários - Removido PDF.js -->
    <script src="plugins/fuse/fuse.min.js"></script>
    <!-- Link para o novo JavaScript sem dependência do PDF.js -->
    <script src="dist/js/snciProcessos_buscaPDF_novo.js"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#searchFaqForm').on('submit', function(e) {
                ...
                // O form já tem o handler configurado em snciProcessos_buscaPDF_novo.js
                // que será executado após estas animações
            });
            
            // Configurar botão de cancelamento
            $("#cancelSearch").on("click", function() {
                // Verificar se a variável está definida no escopo global
                if (typeof searchInProgress !== 'undefined' && searchInProgress) {
                    searchCanceled = true;
                    $(this)
                        .prop("disabled", true)
                        .html('<i class="fas fa-spinner fa-spin mr-1"></i> Cancelando...');
                    
                    // O cancelamento efetivo é tratado no JavaScript
                }
            });
        });
    </script>

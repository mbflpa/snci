											...
											<cfoutput>
												...
												<cfif rsMelhoria.pc_aval_melhoria_status eq 'T'>
													<fieldset style="padding:0px!important;min-height: 90px;">
														...
														<pre class="font-weight-light " style="color:##0083ca!important;font-style: italic;max-height: 100px; overflow-y: auto;margin-bottom:10px">#rsMelhoria.pc_aval_melhoria_sugestao#</pre>
													</fieldset>
												<cfelseif rsMelhoria.pc_aval_melhoria_status eq 'R'>
													<fieldset style="padding:0px!important;min-height: 90px;">
														...
														<cfif rsMelhoria.pc_aval_melhoria_naoAceita_justif neq ''>                                        
															<pre class="font-weight-light " style="color:##0083ca!important;font-style: italic;max-height: 100px; overflow-y: auto;margin-bottom:10px">#rsMelhoria.pc_aval_melhoria_naoAceita_justif#</pre>
														<cfelse>
															<pre class="font-weight-light " style="color:##0083ca!important;font-style: italic;max-height: 100px; overflow-y: auto;margin-bottom:10px">Não Informado</pre>
														</cfif>
													</fieldset>
												<cfelse>

			...
			<div class="row" style="width: 100%;">
				...
				<div class="col-12">
					<div class="card" >
						...
						<!-- card-body -->
						<div class="card-body" >		
							<cfoutput><h5 style="color:##000;text-align: left;margin-bottom: 20px;">Dados utilizados no cálculo do <strong>PRCI</strong> (Atendimento ao Prazo de Resposta): #monthAsString(arguments.mes)#/#arguments.ano# </h5></cfoutput>
			...
			<div class="row" >
				...
				<div class="col-12">
					<div class="card" >
						<!-- card-body -->
						<div class="card-body" >
							<cfoutput><h5 style="color:##000;text-align: left; margin-bottom: 20px;margin-bottom: 20px;margin-bottom: 20px;">Dados utilizados no cálculo do <strong>SLNC</strong> (Solução de Não Conformidades): #monthAsString(arguments.mes)#/#arguments.ano# </h5></cfoutput>
	...
	<cffunction name="tabResumoSLNCorgaosResp_mensal" access="remote" returntype="string" hint="cria tabela resumo com as informações dos resultados do SLNC dos órgãos subordinadores">
		...
		<cfif resultado.recordcount neq 0>
			<div id="divTabResumoSLNCorgaos" class="table-responsive">
				<table id="tabResumoSLNCorgaos" class="table table-striped text-nowrap table-responsive  " style="width:350px; cursor:pointer">
					<cfoutput>
	...
	<cffunction name="tabResumoDGCIorgaosResp_mensal" access="remote" returntype="string" hint="cria tabela resumo com as informações dos resultados do DGCI dos órgãos subordinadores">
		...
		<cfif resultado.recordcount neq 0>
			<div id="divTabResumoDGCIorgaos" class="table-responsive">
				<table id="tabResumoDGCIorgaos" class="table table-striped text-nowrap table-responsive  " style="width:350px; cursor:pointer">
					<cfoutput>

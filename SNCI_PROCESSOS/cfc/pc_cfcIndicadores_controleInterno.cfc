...
<cfprocessingdirective pageencoding = "utf-8">	
	...
	<cffunction name="tabDGCImes_A_mes_mensal_CI2" access="remote" returntype="string" hint="cria tabela com as informações dos resultados do DGCI mês a mês para consulta do Controle Interno">
		<cfargument name="ano" type="string" required="true" />
		<cfargument name="mes" type="string" required="true" />

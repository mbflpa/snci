     ...
     if(window.opener.closed) {  
          ...
          function InsereImagem(img,largura){
               ...
               <cfif '#url.editor#' neq 'Melhoria' >
                   ...
                   if(dir == 'imagens'){
                         if(alinhamento == 'left'){
                              imagemHtml = '<figure style="float:left;"><figcaption>Informe um t�tulo aqui...</figcaption><img style="cursor:pointer;float:left;" onclick="' + newwindow  + '" src=' + img + ' width="'+ largura + '" ></figure>';
                         }
                         if(alinhamento == 'center'){
                              imagemHtml = '<div style="text-align:center;background:#fff"><figure style="text-align:center;background:#fff;border:0px"><figcaption>Informe um t�tulo aqui...</figcaption><img onclick="' + newwindow  + '" src=' + img + ' width="'+ largura + '"  style="cursor:pointer;display: block;margin-left: auto;margin-right: auto"></figure></div><br>';
                         }
                         if(alinhamento == 'right'){
                              imagemHtml = '<figure style="float:right;"><figcaption>Informe um t�tulo aqui...</figcaption><img style="cursor:pointer;float:right;" onclick="' + newwindow  + '" src=' + img + ' width="'+ largura + '" ></figure>';
                         }
                    }else{
                         if(alinhamento == 'left'){
               ...
               <cfelse>
                   imagemHtml = '<figure><div align="center"><figcaption>Informe um t�tulo aqui...</figcaption><img onclick="' + newwindow  + '" src=' + img + ' width="'+ largura + '"  style="cursor:pointer;display: block;margin-left: auto;margin-right: auto"></div></figure><br><br>';     
               </cfif>
...
<body id="main_body"  style="background:#fff">
     ...
     name="formListFile" style="width:714px" class="appnitro" enctype="multipart/form-data" method="post" >
          ...
          <h1 style="background: #1473e6;width:100%;height:50px;color:#fff;font-size:14px;border:4px solid #fff">
          <cfif '#url.editor#' eq 'Melhoria'>
               <cfif '#limiteImagens#' is false >
                    <div style="position:absolute;top:45px;left:40px">Clique para enviar uma imagem ao servidor:</div>
               ...
               <cfelse>
                    <div style="left:40px">O n�mero m�ximo de imagens enviadas ao servidor para este item foi atingido.</div>
          ...
          <cfif isDefined('form.grupo') >
               ...
               <cfif '#url.editor#' neq 'Melhoria' and '#myList.RecordCount#' eq 0> 
                    ...
                    <div align="right" style="margin-top:10px;">
                         <a type="button" onclick="return MudaPasta()" href="#" class="botaoCad" style="background:#1473e6;color:#fff;font-size:12px;padding:5px;margin-top:10px">

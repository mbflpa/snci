...
<cfquery datasource="#dsn_processos#" name="rsAvaliacoesStatus">
...
<cfquery datasource="#dsn_processos#" name="rsOrgaos">
	SELECT pc_orgaos.*
	FROM    pc_orgaos
...
<cfquery datasource="#dsn_processos#" name="rsPosicionamentos">
...
<cfquery datasource="#dsn_processos#" name="rsProcessos">
	select pc_processos.* from pc_processos
</cfquery> 

<cfquery datasource="#dsn_processos#" name="rsProcessosStatus">
	select pc_status.* from pc_status
</cfquery> 

<cfquery datasource="#dsn_processos#" name="rsPerfis">
	select pc_perfil_tipos.* from pc_perfil_tipos
</cfquery> 

<cfquery datasource="#dsn_processos#" name="rsUsuarios">
